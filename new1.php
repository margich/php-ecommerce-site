...
include $_SERVER['DOCUMENT_ROOT'].'/includes/title/title-cart.php';
include $_SERVER['DOCUMENT_ROOT'].'/includes/head-min.php';
include $_SERVER['DOCUMENT_ROOT'].'/includes/off-nav.php';
...
<div class="col-md-12">
	<div class="row">
		...
		<?php if($cart_id == ''): ?>
			...
			<h2><a href="/index.php" class="text-success">Start Shopping</a></h2>
		<?php endif; ?>
		<?php if ($cart_id != ''): ?>
							...
							<div id="step1" class="row" style="display:block">
								<div class="col-md-6" style="border-right: 1px solid #D3D2E9;">
									...
									<input type="hidden" name="grand_total" value="<?=$grand_total;?>">
									  ...
									  <div class="form-group">
										<p class="text-center"><a href="/user/user/create_account.php">Create Account</a></p>
									  </div>
									  <?php endif; ?>
								</div>
								<div class="col-md-6">
...
function validate_login(){
	...
	if(email == ''){
		...
		jQuery.ajax({
			url: 'admin/parsers/validate_login.php',
			method: "post",
			data: data,
...
function validate_guest(){
	...
	if(guest_email == ''){
		...
		jQuery.ajax({
			url: '/admin/parsers/validate_guest.php',
			method: "post",
			data: data,
			success : function(data){
				if(data != 'passed') {
...
function insert_password(){
	...
	jQuery.ajax({
		url: '/admin/parsers/add_user.php',
		method: "post",
		data: data,
		success : function(data){
			if(data != 'passed') {
