...
include $_SERVER['DOCUMENT_ROOT'].'/retlug/includes/title/title-popular.php';
...
?>
    ...
    <div class="row">
		<div class="container">
			<h1 class="h1-list">Most Popular</h1><hr>
			<ul class="breadcrumb">
				<li><a href="/">Home</a></li>
				<li>Most Popular</li>
			</ul>
			<div class="product">
				<?php while($product = mysqli_fetch_assoc($popularQ)) :
						$price = $product['price'];
				?>
				<div class="col-md-3 col-sm-4 col-xs-12 text-center pro-hover" style="cursor:pointer;">
					...
					<div onclick="location.href='product.php?item=<?=$product['product_id'];?>'">
						...
						<img src="<?=$photos[0]; ?>" name="<?php echo $product['title']; ?>" alt="<?php echo $product['title']; ?>" class="img-show"/>
